...
<Callout variant="tip" title="Continued in Field Notes">
  What happened next is a longer story than this page wants: dozens of automated reviews on that other project, and none of them asked the question that would have found it. That is the subject of [What was the review ever for?](/notes/what-was-the-review-ever-for/). The C4 canvas also owes something to the [summaries essay](/notes/summaries-all-the-way-down/): a three-second TLDR, an expandable assessment, and the untruncated diff underneath, so the reader picks the altitude and the detail stays attached.
</Callout>
