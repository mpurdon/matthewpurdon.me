...
Here's the thing nobody wants to say out loud in the AI argument: the code review was already broken before the robots showed up. Fifteen years of LGTM and a thumbs-up emoji on a forty file PR. "can you approve this real quick, it's blocking the release" ... all it takes is trusting that the author "knew what they were doing", and then we all wrote the review step up in the postmortem like it was a control that existed. It really sucks when your name is on the list of approvers for a PR that set the world on fire.
