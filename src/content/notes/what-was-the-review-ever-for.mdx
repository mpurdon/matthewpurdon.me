...
<Soapbox variant="aside" label="Hot take" signoff="the dashboard doesn't know it's July">

Show anything but passing curiosity at these numbers and your confidence in them will plummet. Did throughput drop because the tooling got worse, or because it was July and half the team was at a cottage? Did PRs take longer to close, or did GitHub have yet another all-day outage? Nobody asks. It goes on a slide with an arrow on it and now it's a fact. How you count decides the story as much as whatever it was you counted.
...
Here's the thing nobody wants to say out loud in the AI argument: the code review was already broken before the robots showed up. "can you approve this real quick, it's blocking the release" ... all it takes is trusting that the author "knew what they were doing", to toss a LGTM! on it. Then we all wrote the review step up in the postmortem and solemnly nodded at each other that we can check off "best practices" and "coding standards" were followed. It really sucks when your name is on the list of approvers for a PR that set the world on fire.

So when someone tells me AI is making code review too hard I want to know which code review, because the one I keep seeing in the metrics was never really a review. It was a merge delay with a person's name on it.

I'm not saying throw it out. I'm saying stop pretending. You have two options and only two: make the review real, which costs time you will have to actually take from somewhere, or admit it isn't valuable and spend that effort where it lands (design conversations, tests that mean something, a limit that makes invisible costs visible before the quota does). What you can't keep doing is running a dog and pony show and calling it a "quality gate". Everyone knows the emperor is not wearing any clothes. We've all known for years.
