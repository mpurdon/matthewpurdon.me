...
There is a second thing hiding under the first, and it is bigger than Postman. When generating the whole app costs an evening, code stops being something you pour your heart into and becomes disposable: the by-product of an answer, not a possession. For a task that small I did not read the source, [did not review it](/notes/what-was-the-review-ever-for/), and I genuinely do not care how it is written. The only question that earns any attention is whether it returns the right rows.
