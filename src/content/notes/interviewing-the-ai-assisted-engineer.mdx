...
If you keep testing people on how fast they can spit out syntax, you'll end up with a team that can generate code they can't explain, and [review processes that turn into rubber stamps](/notes/what-was-the-review-ever-for/). Stop treating your interview loop like a Glengarry boiler room. Put the whiteboard down. Coffee is for coders, but the Cadillac is for curators. Stop asking for the steak knives. ABC: Always Be Curating.
