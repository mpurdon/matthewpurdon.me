...
export const PROJECTS = [
  ...
  },
  {
    ...
    summary:
      "A weekend experiment with the open-source pi coding agent that grew into a daily-driver harness on AWS Bedrock: persistent memory, per-branch checkpoints, secret scanning, budget caps, background PR watches, and a second-opinion review gate. Built for a corporate account, where every wasted token is a line item.",
